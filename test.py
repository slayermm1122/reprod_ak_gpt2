...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, num_heads, head_size):
        ...
        self.proj = nn.Linear(n_embd, n_embd) #projection layer to weighted sum of heads, and this layer can project back to the residual pathway.
        self.dropout = nn.Dropout(dropout)
...
model.load_state_dict(torch.load('/Users/yanli1122/code/ng-video-lecture/gpt_model.pth', weights_only=True))
model.eval()
